...
def main():
    ...
    r1 = app.ReleaseRow(artist_display="Various Artists", title="Zebra Songs", year=2000, label="", catno="", country="", format_str="", discogs_url="", notes="", release_id=None)
    ...
    r2 = app.ReleaseRow(artist_display="Various Artists", title="Alpha Tunes", year=1999, label="", catno="", country="", format_str="", discogs_url="", notes="", release_id=None)
